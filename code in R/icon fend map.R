...
imageUrl <- "fendmap.png"

# Create a custom icon
iconfendmap <- makeIcon(iconUrl = imageUrl, iconWidth = 20, iconHeight = 20)
...
map <- leaflet() %>%
  ...
  addMarkers(lng = -73.9857, lat = 40.7484, icon = iconfendmap) # add marker with custom icon
