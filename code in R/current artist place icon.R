...
imageUrl <- "currentplace.png"

# Create a custom icon
iconCurrentPlace <- makeIcon(iconUrl = imageUrl, iconWidth = 50, iconHeight = 50)
...
map <- leaflet() %>%
  ...
  addMarkers(lng = -73.9857, lat = 40.7484, icon = iconCurrentPlace) # add marker with custom icon
